...
const ProductsPage: React.FC = () => {
  ...
  const [heroBgImage, setHeroBgImage] = useState<ImagePlaceholder | undefined>();
  const [introArtImage, setIntroArtImage] = useState<ImagePlaceholder | undefined>();
  ...
  useEffect(() => {
    ...
    setHeroBgImage(PlaceHolderImages.find(p => p.id === 'product-hero-background'));
    setIntroArtImage(PlaceHolderImages.find(p => p.id === 'page-intro-art'));
    setLoading(false);
  }, []);
