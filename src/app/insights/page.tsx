...
const InsightsPage: React.FC = () => {
  ...
  const thoughts = mockResearchData.filter(insight => 
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-foreground/60 font-body">Loading insights...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="w-full px-4 sm:px-6 lg:px-16 2xl:px-24">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 xl:gap-16 items-center">
              ...
              <div className="lg:col-span-7 2xl:col-span-6">
                  <AnimatedSection>
                      <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl">Advanced Insights</h1>
                      <p className="mt-6 text-xl text-white/80 max-w-xl">
                        Explore our comprehensive insights database featuring cutting-edge studies, white papers, and case studies that shape the future of human-technology collaboration.
                      </p>
                  </AnimatedSection>
                      ...
                      <AnimatedSection delay={0.1} className="flex-grow">
                           <Card className="bg-white/10 backdrop-blur-md border-white/20 h-full group flex flex-col">
                              <Link href={`/insights/${featuredInsight._id}`} className="block h-full flex flex-col">
                                ...
                                <CardHeader>
                                    <Badge variant="secondary" className="w-fit">Featured Insight</Badge>
        ...
        <div className="max-w-[120rem] mx-auto px-16">
            <AnimatedSection className="text-center mb-16">
                ...
                <p className="text-lg font-body text-foreground/80 max-w-3xl mx-auto">
                    Forward-looking perspectives and speculative analyses on the future of technology and society.
                </p>
            </AnimatedSection>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                {thoughts.map((insight, index) => (
                    <motion.div
                      key={insight._id}
      ...
      <section className="py-24 bg-background">
        <div className="max-w-[120rem] mx-auto px-16">
          ...
          >
            <h2 className="text-4xl font-headline font-normal text-primary mb-6">Insight Categories</h2>
            <p className="text-lg font-body text-foreground/80 max-w-3xl mx-auto">
              Our insights span multiple domains, providing comprehensive perspectives into 
        ...
        <div className="max-w-[120rem] mx-auto px-16">
          ...
          >
            <h2 className="text-4xl font-headline font-bold text-primary-foreground mb-6">
              Partner with Our Insights Team
            </h2>
            <p className="text-lg font-body text-primary-foreground/80 mb-8 max-w-3xl mx-auto">
              Collaborate with our experts to conduct custom studies tailored to your 
