...
const CaseStudyDetailPage: React.FC = () => {
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground font-body">Loading case study...</p>
        </div>
      </div>
    );
  }
  ...
  if (!insight) {
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-headline font-bold text-primary mb-4">Case Study Not Found</h1>
          <p className="text-muted-foreground font-body mb-8">The case study you're looking for doesn't exist.</p>
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            >
              <Link href="/case-studies">
                ...
                <span className="hidden md:inline">Back to Case Studies</span>
              </Link>
            </Button>
          ...
          <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-lg font-body text-foreground max-w-2xl mx-auto">
                Continue exploring our research with these related articles and case studies.
              </p>
            </motion.div>
              ...
              {relatedInsights.map((relatedInsight, index) => (
                ...
                >
                  <Card className="h-full hover:shadow-xl hover:shadow-accent/10 transition-all duration-300 ease-apple hover:-translate-y-2 bg-background border-0 shadow-sm group">
                    <Link href={`/case-studies/${relatedInsight._id}`} className="block h-full">
