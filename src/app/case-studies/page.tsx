...
export default function CaseStudiesPage() {
  ...
  const [filteredInsights, setFilteredInsights] = useState(LATEST_INSIGHTS);
  ...
  useEffect(() => {
    const results = LATEST_INSIGHTS.filter(insight => {
        ...
        <div className="w-full px-4 sm:px-6 lg:px-16 2xl:px-24">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 xl:gap-16 items-center">
              ...
              <div className="lg:col-span-7 2xl:col-span-6">
                  <AnimatedSection>
                      <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl">Unlocking Tomorrow's Case Studies</h1>
          ...
          {filteredInsights.length === 0 ? (
            <div className="text-center py-16">
              ...
              <p className="text-base font-body text-foreground/80 mb-8">
                Try adjusting your search terms or browse all case studies.
              </p>
              <Button
