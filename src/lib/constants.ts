...
export const LEADERSHIP_TEAM = [
    ...
    { name: "Mayurika Dutta", role: "Subject Matter Expert - Transformation", bio: "Seasoned transformation and transition leader with extensive experience supporting organisations through complex, large-scale transitions, operating model redesign, and enterprise transformation programs. Specialises in end-to-end transition delivery, spanning discovery, due diligence, and business case development through detailed transition planning, execution, stabilisation, and benefits realisation. Demonstrated success leading multi-region transitions, establishing global hubs and shared services, and embedding robust governance, risk controls, and change frameworks to ensure continuity of service and sustained performance. Brings a structured, data-driven approach to transformation, combining target operating model design, PMO and transformation office setup, lean-driven process optimisation, and executive-level reporting to deliver measurable outcomes. Has led $10M+ portfolios, delivered $3M+ in annual cost savings, improved delivery predictability, and accelerated time-to-value through automation and AI enabled solutions. Recognised for strong client engagement, clear executive communication, and effective partnership with business and technology leaders to align strategy with execution, manage risk, uplift organisational capability, and embed lasting change. Driven by a passion for travel, a love of food, and a curiosity for experiencing and understanding different cultures, embodying a truly global mindset.", imageId: "leader5" },
