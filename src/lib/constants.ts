...
export const LEADERSHIP_TEAM = [
    ...
    { name: "Mayurika Dutta", role: "Subject Matter Expert - Transformation", bio: "Mayurika Dutta is a subject matter expert specializing in large-scale business and digital transformation. She brings a wealth of experience in guiding organizations through complex change initiatives, ensuring strategic alignment and successful adoption of new technologies and processes.", imageId: "leader5" },
