...
export const LEADERSHIP_TEAM = [
    ...
    { name: "Rika Dutta", role: "Subject Matter Expert - Transformation", bio: "Rika Dutta is a subject matter expert specializing in large-scale business and digital transformation. She brings a wealth of experience in guiding organizations through complex change initiatives, ensuring strategic alignment and successful adoption of new technologies and processes.", imageId: "leader5" },
...
export const PRODUCTS = [
    ...
    { id: "thinkquark", name: "ThinkQuark™", description: "Harness the power of quantum-inspired computing to solve your most complex optimization problems.", icon: BrainCircuit, imageId: 'product-thinkquark', tagline: 'Solve the unsolvable.', detailedDescription: 'ThinkQuark™ is a revolutionary platform that brings quantum-inspired algorithms to classical hardware, allowing you to tackle combinatorial optimization problems that are intractable for conventional systems. From logistics and supply chain to financial modeling and drug discovery, unlock new levels of performance and find optimal solutions in record time.', keyBenefits: "Solve complex optimization problems faster.\nUnlock new possibilities in research and development.\nGain a competitive edge with cutting-edge technology.\nIntegrate seamlessly with your existing data pipelines.", learnMoreUrl: '#' },
    { id: "singleone", name: "SingleOne™", description: "A unified platform for holistic enterprise intelligence, from strategy to execution.", icon: Gem, imageId: 'product-singleone', tagline: 'The single source of truth.', detailedDescription: 'SingleOne™ breaks down data silos and provides a unified, real-time view of your entire organization. By integrating data from strategy, finance, operations, and human resources, SingleOne™ empowers leaders to make holistic decisions with confidence. It is the single source of truth for enterprise performance.', keyBenefits: "Achieve a holistic view of your business.\nEliminate data silos and discrepancies.\nAlign strategy with execution in real-time.\nEmpower leaders with actionable, unified intelligence.", learnMoreUrl: '#' },
];
